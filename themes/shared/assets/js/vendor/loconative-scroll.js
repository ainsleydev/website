...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		...
		: ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
		  (global.LoconativeScroll = factory()));
})(this, function () {
	'use strict';
		...
		_createClass(_default, [
			...
			},
			{
				...
				value: function setScrollTo(event) {
					...
					this.scrollTo(
						event.currentTarget.getAttribute('data-'.concat(this.name, '-href')) ||
					...
					Object.defineProperty(this, r, { writable: !0, value: void 0 }),
						...
						(this._onWheel = function (e) {
							...
							(o.deltaX = e.wheelDeltaX || -1 * e.deltaX),
								...
								s.isFirefox &&
									1 === e.deltaMode &&
									((o.deltaX *= n.firefoxMultiplier), (o.deltaY *= n.firefoxMultiplier)),
						...
						(i(this, l)[l] = new o()),
						(i(this, u)[u] = { y: 0, x: 0, deltaX: 0, deltaY: 0 }),
						(i(this, c)[c] = { x: null, y: null }),
						(i(this, d)[d] = null),
						void 0 !== i(this, r)[r].passive && (this.listenerOptions = { passive: i(this, r)[r].passive });
				}
				var t = e.prototype;
				return (
					...
					(t._bind = function () {
						s.hasWheelEvent && i(this, a)[a].addEventListener('wheel', this._onWheel, this.listenerOptions),
							s.hasMouseWheelEvent &&
								i(this, a)[a].addEventListener('mousewheel', this._onMouseWheel, this.listenerOptions),
							s.hasTouch &&
								i(this, r)[r].useTouch &&
								(i(this, a)[a].addEventListener('touchstart', this._onTouchStart, this.listenerOptions),
					...
					(t._unbind = function () {
						s.hasWheelEvent && i(this, a)[a].removeEventListener('wheel', this._onWheel),
							...
							s.hasTouch &&
								(i(this, a)[a].removeEventListener('touchstart', this._onTouchStart),
		...
		l = /*#__PURE__*/ (function () {
			...
			return (
				...
				(e.raf = function (t) {
					var e = this;
					if (this.isRunning) {
						this.currentTime = Math.min(this.currentTime + 0.001 * t, this.duration);
				...
				((s = t.call(this) || this).onWindowResize = function () {
					...
					(s.onVirtualScroll = function (t) {
						var e = t.deltaY,
							...
							i = t.originalEvent;
						i.ctrlKey ||
							((s.smooth = i.changedTouches ? s.smoothTouch : s.options.smooth),
							s.stopped
								? i.preventDefault()
								: s.smooth &&
								  4 !== i.buttons &&
								  (s.smooth && i.preventDefault(),
								  (s.targetScroll -=
					...
					(s.onScroll = function (t) {
						(s.isScrolling && s.smooth) ||
							((s.targetScroll = s.scroll = s.lastScroll = s.wrapperNode[s.scrollProperty]), s.notify());
					}),
					...
					(s.touchMultiplier = m),
					(s.direction = b),
					(s.gestureDirection = N),
					(s.wrapperNode = z),
					(s.contentNode = W),
					s.wrapperNode.addEventListener('scroll', s.onScroll),
					s.wrapperNode === window
						? (s.wrapperNode.addEventListener('resize', s.onWindowResize), s.onWindowResize())
					...
					(s.animate = new l());
				var T =
					(null == (i = navigator) || null == (r = i.userAgentData) ? void 0 : r.platform) ||
					(null == (n = navigator) ? void 0 : n.platform) ||
					'unknown';
				return (
					(s.virtualScroll = new virtualscroll({
						el: s.wrapperNode,
						firefoxMultiplier: 50,
						mouseMultiplier: T.includes('Win') ? 1 : 0.4,
						useKeyboard: !1,
			...
			return (
				...
				(c.scrollTo = function (t, e) {
					...
					if (null != t) {
						...
						(this.targetScroll = p += r),
							!this.smooth || s
								? this.setScroll(this.targetScroll)
								: this.animate.to(this, { duration: c, easing: h, scroll: this.targetScroll });
					}
				}),
				i(s, [
					{
			...
			},
			{
				...
				value: function addElements() {
					...
					els.forEach(function (el, index) {
						...
						var id =
							typeof el.dataset[_this4.name + 'Id'] === 'string' ? el.dataset[_this4.name + 'Id'] : index;
						var top;
						var left;
						var offset =
						...
						var speed = el.dataset[_this4.name + 'Speed']
							? parseFloat(el.dataset[_this4.name + 'Speed']) / 10
							: false;
									...
									if (typeof offset[i] == 'string') {
										if (offset[i].includes('%')) {
											relativeOffset[i] = parseInt(
												(offset[i].replace('%', '') * _this4.windowWidth) / 100,
											);
										} else {
					...
					Object.entries(this.parallaxElements).forEach(function (_ref5) {
						...
						if (current.inView || setAllElements) {
							switch (current.position) {
								...
								case 'bottom':
									transformDistance =
										(_this6.instance.limit[_this6.directionAxis] -
											scrollBottom +
											_this6.windowHeight) *
										current.speed;
									break;
								...
								default:
									transformDistance =
										(scrollMiddle[_this6.directionAxis] - current.middle[_this6.directionAxis]) *
										-current.speed;
									break;
							}
						}
						...
						if (current.sticky) {
							if (current.inView) {
								...
								if (_this6.direction === 'horizontal') {
									if (
										_this6.instance.scroll.x < current.left - _this6.windowWidth &&
										_this6.instance.scroll.x < current.left - _this6.windowWidth / 2
									) {
										transformDistance = 0;
									} else if (
										_this6.instance.scroll.x > current.right &&
										_this6.instance.scroll.x > current.right + 100
									) {
									...
									if (
										_this6.instance.scroll.y < current.top - _this6.windowHeight &&
										_this6.instance.scroll.y < current.top - _this6.windowHeight / 2
									) {
										transformDistance = 0;
									} else if (
										_this6.instance.scroll.y > current.bottom &&
										_this6.instance.scroll.y > current.bottom + 100
									) {
						...
						if (transformDistance !== false) {
							if (
								...
								(_this6.direction === 'horizontal' && current.direction !== 'vertical')
							) {
